...
public class CustomWatchFaceService extends CanvasWatchFaceService {
    ...
    private class WatchFaceEngine extends Engine {
        ...
        //Member variables
        private Typeface WATCH_TEXT_TYPEFACE = Typeface.create( Typeface.DEFAULT, Typeface.NORMAL );
        ...
        private void drawBackground( Canvas canvas, Rect bounds ) {
            if(!isInAmbientMode()){
                Bitmap background = BitmapFactory.decodeResource(getResources(), R.drawable.sm_nerv);
                canvas.drawBitmap(background, 0, 0,mBackgroundColorPaint);
            } else {
